...
if(COMMONCPPGNU_INCLUDE_DIR AND COMMONCPPGNU_LIBRARIES)
	...
	endif(NOT CommonCPPGNU_FIND_QUIETLY)
else(COMMONCPPGNU_INCLUDE_DIR AND COMMONCPPGNU_LIBRARIES)
	if(CommonCPPGNU_FIND_REQUIRED)
		message(FATAL_ERROR "Could not find CommonCPPGNU")
	else(CommonCPPGNU_FIND_REQUIRED)
		if(NOT CommonCPPGNU_FIND_QUIETLY)
			message(STATUS "Could not find CommonCPPGNU")
		endif(NOT CommonCPPGNU_FIND_QUIETLY)
	endif(CommonCPPGNU_FIND_REQUIRED)
endif(COMMONCPPGNU_INCLUDE_DIR AND COMMONCPPGNU_LIBRARIES)
