...
OBJECTS = Album.o Database.o FileMetadata.o FileMetadataConstants.o FileReader.o Levenshtein.o Locutus.o Metadata.o PUIDGenerator.o Settings.o WebService.o
