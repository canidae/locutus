...
OBJECTS = Album.o Artist.o Database.o FileMetadataConstants.o FileReader.o Levenshtein.o Locutus.o Metafile.o Metatrack.o PUIDGenerator.o Settings.o Track.o WebFetcher.o WebService.o XMLNode.o
